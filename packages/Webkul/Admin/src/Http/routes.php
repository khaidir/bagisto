...
Route::get('/login', 'Webkul\Api\Http\Controllers\Admin\ApiClientController@login')->defaults('_config', [
    'view' => 'admin::api-client.login'
])->name('login');

Route::post('/login', 'Webkul\Api\Http\Controllers\Admin\ApiClientController@postLogin')->name('admin.post-login');
